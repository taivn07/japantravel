...
module CarrierWave
  module Video
    ...
    module ClassMethods
      ...
      def thumb_video(target_format, options={})
        process thumb_video: [target_format, options]
      end
    ...
    def thumb_video(format, opts={})
      ...
      with_trancoding_callbacks do
        file.screenshot(tmp_path, @options.format_params, @options.encoder_options)
        File.rename tmp_path, current_path
      end
    end
